  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Positioned.fill(
          child: Container(
            color: AppColor.darkGreen, // Color verde claro
          ),
        ),
        ...
        Positioned(
          ...
          right: 0,
          child: Container(
            color: AppColor.lightGreen, // Color verde oscuro
            height: MediaQuery.of(context).size.height * 0.31, // Altura del área debajo de la curva
          ),
        ),

        // Curva en la parte inferior con `ClipPath`
        Positioned(
          bottom: MediaQuery.of(context).size.height * 0.3, // Ajuste para que la curva esté a 30% de la altura
          left: 0,
          right: 0,
          child: ClipPath(
            clipper: BottomCurveClipper(),
            child: Container(
              color: AppColor.lightGreen, // Color verde oscuro para la curva

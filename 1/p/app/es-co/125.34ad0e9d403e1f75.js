  ...
  class MessageEditCustomerDialogComponent {
    ...
    ngOnInit() {
      if (this.dialogData.selectOption == 'myCompany' || !this.dialogData.isAgent) {
        this.message = " module.business.management.customer.management.form.confirm.text.action.edit.my.company";
      } else {
        this.message = " module.business.management.customer.management.form.confirm.text.action.edit";
      }
    }
  }
  ...
  class CustomerManagementFormConfirmComponent {
    ...
    ngOnInit() {
      ...
      if (this.dialogData.action == 'create') {
        this.messageAction = " module.business.management.customer.management.form.confirm.text.action.create";
        this.messageActionAcept = " module.business.management.customer.management.form.confirm.text.action.confirmation.create";
        this.messageActionNotification = " module.business.management.customer.management.form.confirm.text.action.create.notification";
        this.messageActionForPDF = " module.business.management.customer.management.form.confirm.text.action.create.pdf";
      } else {
        this.messageAction = " module.business.management.customer.management.form.confirm.text.action.edit";
        this.messageActionAcept = " module.business.management.customer.management.form.confirm.text.action.confirmation.edit";
        this.messageActionNotification = " module.business.management.customer.management.form.confirm.text.action.edit.notification";
        this.messageActionForPDF = " module.business.management.customer.management.form.confirm.text.action.edit.pdf";
      }
    ...
    createRequestCustomer(value) {
      if (!this.isCreateNewRequest) {
        ...
        this.businessManagementService.createCustomerRequest(this.customerRequest).pipe((0,takeUntil/* takeUntil */.R)(this.destroy$), (0,catchError/* catchError */.K)(error => {
          this.matSnackBar.open(" modules.business.management.customer.management.form.confirm.create.request.error", "", {
          ...
          this.matSnackBar.open(" modules.business.management.customer.management.form.confirm.create.request.success", "", {
            verticalPosition: "top",
            duration: 7000,
...
let CustomerRequestInProgressMessageComponent = /*#__PURE__*/(() => {
  class CustomerRequestInProgressMessageComponent {
    ...
    ngOnInit() {
      this.message = " module.business.management.customer.request.in.progress.message";
    }
  }
    ...
    loadNewDocuments(element) {
      ...
      let subscriptionGetStateLoadDocumentsFromGESTCLIE = this.statesServiceBusinessManagement.getStateLoadDocumentsFromGESTCLIE().pipe((0,takeUntil/* takeUntil */.R)(this.destroy$)).subscribe(isLoad => {
        if (isLoad) {
          ...
          this.matSnackBar.open(" modules.business.management.customer.request.management.component.update.documents.success", "", {
            verticalPosition: "top",
            duration: 7000,
            panelClass: ["success-snackbar"]
          });
  ...
  BusinessManagementComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_0 = " module.business.management.tab.register ";
      }
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_2 = " module.business.management.tab.request ";
      }

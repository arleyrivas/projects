  ...
  class GeneratePinDisplayItemComponent {
    ...
    deleteUnit(unit, buttonElement) {
      this.contanerizedLoadService.getContainerizedLoad(this.base64EncryptionUtilService.encrypt(this.lastSearch)).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_9__/* .mergeMap */ .z)(encryptedContainers => {
        ...
        this.matSnackBar.open(" modules.search.error", "", {
    ...
    getMessage(message, param) {
      switch (message) {
        case "modules.containerized-load.hasPin":
          return " modules.containerized-load.hasPin";
          break;
        case "detached-load.hasChargeableUnitEvents":
          return " modules.detached-load.hasChargeableUnitEvents";
          break;
        case "detached-load.hasDebt-false":
          return " modules.detached-load.hasDebt-false";
          break;
        case "detached-load.hasDebt-true":
          return " modules.detached-load.hasDebt-true";
          break;
        case "detached-load.hasHolds":
          return " modules.detached-load.hasHolds " + param + "";
          break;
        case "modules.detached-load.storageDaysOwed":
          return " modules.detached-load.storageDaysOwed";
          break;
        case "modules.detached-load.yard":
          return " modules.detached-load.yard";
          break;
        case "modules.detached-load.holdConsigneeActive-true":
          return " modules.detached-load.holdConsigneeActive-true";
          break;
        case "modules.detached-load.holdConsigneeActive-null":
          return " modules.detached-load.holdConsigneeActive-null";
          break;
        case "modules.detached-load.truck_visit_appt_nbr":
          return " modules.detached-load.truck_visit_appt_nbr";
          break;
        default:
  ...
  ContainerizedLoadResultComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_0 = " breakbulk.views.search.import.DETAIL_HBL.IMPORTADOR ";
      }
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_2 = " breakbulk.views.search.import.DETAIL_HBL.BUQUE ";
      }
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_4 = " breakbulk.views.search.import.DETAIL_HBL.NUMERO_VIAJE ";
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_6 = " agent.views.agent-import-search.BL_CONTAINERS ";
      }
      let i18n_8;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_8 = " config.views.config-users.navbar.CREATE_POSITION_MESSAGE ";
      }
      let i18n_10;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_10 = " breakbulk.views.search.import.DETAIL_HBL.TABLE.CANTIDAD ";
      }
      let i18n_12;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_12 = " breakbulk.views.search.import.DETAIL_HBL.TABLE.PESO ";
      }
      let i18n_14;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_14 = " breakbulk.views.search.import.DETAIL_HBL.TABLE.DESTINO ";
      }
  ...
  InvoiceManagementComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_0 = "history.views.history-truck-list.IMPORT_LABEL";
      }
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_2 = "history.views.history-truck-list.IMPORT_LABEL";
      }
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_4 = "history.views.history-truck-list.EXPORT_LABEL";
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_6 = "history.views.history-truck-list.EXPORT_LABEL";
      }
      let i18n_8;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_8 = "history.views.history-truck-list.EDO_LABEL";
      }
      let i18n_10;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_10 = "history.views.history-truck-list.EDO_LABEL";
      }
      let i18n_12;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_12 = "history.views.history-truck-list.ERO_LABEL";
      }
      let i18n_14;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_14 = "history.views.history-truck-list.ERO_LABEL";
      }
...
let ContainerizedLoadComponent = /*#__PURE__*/(() => {
  class ContainerizedLoadComponent {
    ...
    submit(value) {
      ...
      this.recentBL = value;
      this.notFoundText = " agent.views.agent-import-search.NOT_RESULT " + this.recentBL + "";
    ...
    submitBooking(value) {
      ...
      this.router.navigate(["/", "carga-contenerizada"]);
      this.recentBL = value;
      this.notFoundTextB = " agent.views.agent-import-search.NOT_RESULT " + this.recentBL + "";
  ...
  ContainerizedLoadComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_1 = " agent.views.agent-import-search.TITLE ";
      }
      let i18n_3;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_3 = " agent.views.agent-import-search.TITLE ";
      }
      let i18n_5;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_5 = " export.views.export-search.PAGE_HEADER ";
      }
      let i18n_7;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_7 = " export.views.export-search.PAGE_HEADER ";
      }
      let i18n_9;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_14 = " agent.views.agent-import-actions.CC_CTA_BLOQ ";
      }
      let i18n_16;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_16 = " agent.views.agent-import-actions.CC_CTA_DESBL ";
      }
  ...
  class UploadDocumentsComponent {
    ...
    consigneeValid() {
      ...
      if (!this.blHaveConsignee && this.nitConsignee == '') {
        (0,alert_utils/* showAlertTime */.h)(this.alert, " module.documental.upload.file.notConsignee.message", 'alerta');
        return (0,of.of)(false).pipe((0,take/* take */.q)(1));
      }
          ...
          if (result) {
            if (result.bookingID && (this.infoBooking.length === 0 || this.infoBooking !== result.bookingID)) {
              ...
              result.bookingID.forEach(booking => {
                ...
                if (availableQuantityMoment > 0) {
                  const description = " export.ExportController.CREATE_PREADVISE_NOT_IMO";
            ...
            if (result.physicalContainer && this.associateFormGroup.get('typeEquipment')?.value === "") {
              ...
              if (result.physicalContainer.type) {
                ...
                const message = " export.views.export-preadvice_form.UNIT_ADD_BOOKING_ERROR";
                const messageTwo = " export.views.export-preadvice_form.EQUIPMENT_TYPE_NOT_IN_BOOKING";
              ...
              if (this.continueProcess) {
                if (result.validateContainer !== null && result.digitCheck !== null) {
                  if (result.validateContainer !== 10 && !result.digitCheck) {
                    ...
                    const message = " modules.share.containers.search.invalid.digit.verification";
                    const messageWithNumber = `${message} ${result.validateContainer}`;
                    const messageTwo = " modules.share.containers.search.invalid.digit.option";
          ...
          if (encryptedResponse) {
            ...
            if (this.availableQuantity > 0) {
              ...
              if (result.archetype && result.archetype !== "" && this.archisoList.includes(result.archetype)) {
                ...
                this.errorWeight = " modules.containerized.load.associate.containerbooking.weight.invalid " + this.minWeight + "";
                ...
                if (this.associateFormGroup.get('typeEquipment')?.value) {
                  ...
                  this.equipmentTypeErrorText.push(" export.views.export-preadvice_form.EQUIPMENT_TYPE_NOT_IN_BOOKING");
                  this.showFormWeight = false;
                }
              }
            } else {
              this.equipmetTypeValid = false;
              const messageError = " export.views.export-preadvice_form.UNIT_ADD_BOOKING_ERROR";
              if (!this.isCleanForm) {
            ...
            this.equipmetTypeValid = false;
            this.equipmentTypeErrorText.push(" modules.containerized.load.associate.containerbooking.type.equipment.invalid");
          }
        },
        error: error => {
          console.error(error);
    ...
    getValueItemIso(value, isSelect = true) {
      if (value !== "" && isSelect) {
        ...
        if (itemSelected && itemSelected.description !== "") {
          const descriptionIMO = " export.ExportController.CREATE_PREADVISE_NOT_IMO";
    ...
    makeAssociation() {
      ...
      if (this.infoBooking.length > 0) {
        ...
        this.utilServices.getCreateAssotiation(newBooking, this.base64EncryptionUtilService.encrypt(reference), this.base64EncryptionUtilService.encrypt(transferTemplateNbr), typeDocument).subscribe({
          next: result => {
            if (result) {
              this.showMessage(" modules.containerized.load.associate.containerbooking.success", "success");
              //this.storageService.clearStorageValidationPin();
  ...
  AssociateContainerComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_2 = " modules.containerized.load.associate.containerbooking.type.document.duta ";
      }
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_4 = " modules.containerized.load.associate.containerbooking.type.document.transit ";
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_6 = " modules.containerized.load.associate.containerbooking.type.document.dian ";
      }
      let i18n_8;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_8 = " modules.containerized.load.associate.containerbooking.type.document.plani ";
      }
      let i18n_10;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_10 = " modules.containerized.load.associate.containerbooking.type.document.mov ";
      }
      let i18n_12;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_12 = " modules.containerized.load.associate.containerbooking.type.document.man ";
      }
          ...
          if (resultDialog) {
            if (resultDialog.success) {
              ...
              if (desassociate && !desassociate.error) {
                _this.showMessage(" export.ExportCancelPreadviseController.PREADVISE_CANCELLED", "success");
  ...
  DialogPayComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        ...
        i18n_0 = " history.views.modalTotalPayment.NUMBER_TH ";
      }
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_2 = " history.views.modalTotalPayment.COSTO ";
      }
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_4 = " history.views.modalTotalPayment.CREDITO ";
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        /**
        ...
        i18n_6 = " history.views.modalTotalPayment.AMOUNT_TH ";
      }

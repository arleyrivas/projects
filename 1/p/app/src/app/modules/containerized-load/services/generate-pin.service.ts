...
export class GeneratePinService {
  ...
  public deletePin(body: IGeneratePinDeactivate): Observable<IGeneratePinDeactivatePartial> {
    return this.httpClient.put<IGeneratePinDeactivatePartial>(`${this.apiBaseURL}/portal/api/pin/deactivate-partial`, body);
  }

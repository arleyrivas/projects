	...
	<div class="loginBody">
		<div class="body-content col-sm-12 col-md-12 col-lg-12">
			<div class="login">
				...
				<form action="/businessPortal/api/user/confirm" method="post" role="form">
			  		<div class="title login-title" >
	  					...
	  					<div class="title">
	  						<span class="subheaderTitle">Activaci&oacute;n de usuario</span>
	  					</div>
	  				</div>
					...
					<input type="password" class="password-hide" autocomplete="off" id="password" name="password" >
					<div class="form-group">
					...
					<input type="hidden"  id="j_u" name="j_u" class="form-control" value="${username}">
					<input type="hidden" id="j_o_p" name="j_o_p" class="form-control" value="${hash}">
				  	<input type="submit" class="btn btn-primary btn-lg" value="Confirmar Registro" />
				</form>
	  		</div><!-- /login -->

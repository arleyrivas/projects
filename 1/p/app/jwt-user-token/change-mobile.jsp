...
<body>
	<div class="loginBody">
		<div class="body-content col-sm-12 col-md-12 col-lg-12">
			<div class="login">
				<form action="${pageContext.request.contextPath}/api/mobile-token/change-mobile-confirmation/" method="post" role="form">
			  		<div class="title login-title" >
	  					...
	  					<div class="title">
	  						...
	  						<spring:message code="Controller.JWTUserController.MOBILE_CHANGE" />
	  					</div>
	  				</div>
					...
					<div class="form-group">
				  	...
				  	<div class="form-group">
						...
						<input type="number" ng-requiered="true" min="1000000" max="9999999999" id="j_mobile" name="j_mobile" class="form-control" tabindex="2" autocomplete="off"/>
				  	</div>
				  	
				  	<div class="form-group">
				  		<label for="re-password"><spring:message code="Controller.JWTUserController.MOBILE_REENTER" />:</label>
						<input type="number" ng-requiered="true" min="1000000" max="9999999999" id="j_re_mobile" name="j_re_mobile" class="form-control" tabindex="3" autocomplete="off"/>
				  	</div>

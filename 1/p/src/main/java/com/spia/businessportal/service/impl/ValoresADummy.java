...
public class ValoresADummy {

    public static HBLPinDTO LlenarValoresADummy() {
        // TODO se debe eliminar la seleccion
    	HBLPinDTO hbl = new HBLPinDTO();
        List<CargoLot> cargoLotList = new ArrayList<CargoLot>();
        CargoLot cargolot = new CargoLot();

        cargolot.setId(1);
        cargolot.setPeso(0.100);

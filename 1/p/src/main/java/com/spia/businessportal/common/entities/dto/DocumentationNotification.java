 ...
 *
 */
public class DocumentationNotification implements IAuditLog {

	private static final Log LOG = LogFactory.getLog(DocumentationNotification.class);
	...
	private List<TemplateEmailDTO> mailsNotificationsSAC;
	...
	public List<TemplateEmailDTO> getMailsNotificationsSAC() {
		return mailsNotificationsSAC;
	}

	public void setMailsNotificationsSAC(List<TemplateEmailDTO> mailsNotificationsSAC) {
		this.mailsNotificationsSAC = mailsNotificationsSAC;
	}

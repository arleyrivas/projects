...
public class TSAClient {
     ...
     * @throws IOException
     *             if there was an error with the connection or data from the TSA server, or if the time stamp response could not be validated
     */
    public byte[] getTimeStampToken(byte[] messageImprint) throws IOException {
        ...
        TimeStampRequest request = tsaGenerator.generate(oid.toString(), hash, BigInteger.valueOf(nonce));
